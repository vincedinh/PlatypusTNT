...
// add, sub, div, mul, dot, cross, magnitude, normalize functions modified by Vince Dinh
// some parts are combined from cuon-matrix.js
// modified from asg0 for asg3 to reimplement Vector3
 ...
 */
 ...
 class Vector3 {
  ...
  static cross(other1, other2) {
      ...
      v3.elements[0] = other1.elements[1]*other2.elements[2] - other1.elements[1]*other2.elements[2]
      v3.elements[1] = 0 - (other1.elements[0]*other2.elements[2] - other1.elements[2]*other2.elements[0])
